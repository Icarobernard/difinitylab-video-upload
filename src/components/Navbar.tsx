...
const Navbar: React.FC<NavbarProps> = ({ searchTerm, onSearchTermChange }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-white p-4 flex justify-between items-center">
      <div className="flex items-center">
        <div className="w-4 h-4 bg-green-500 rounded-full hidden md:block"></div>
        <h2 className="ml-2 text-xl font-semibold hidden md:block">Difinity Timeline</h2>
      </div>
